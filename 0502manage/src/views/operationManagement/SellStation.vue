...
<template>
  <section id="sellStationSection">
    ...
    <el-table :data="sellStations" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%" :height="tableHeight">
        ...
        <el-table-column prop="sellStationName" label="售票站点名称" min-width="200">
        </el-table-column>
        <el-table-column prop="area" label="所属区域" min-width="200">
        </el-table-column>
    ...
    data () {
      return {
        ...
        fields: [
          ...
          { name: 'area', value: '', label: '所属区域', type: 'select', choose: [ { text: '厦门', value: '厦门' }, { text: '福州', value: '福州' } ], rules: [ { required: true, message: '请选择所属区域' } ], placeholder: '请选择所属区域' },
