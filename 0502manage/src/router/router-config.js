...
* @Last Modified time: 2018-07-03 15:15:55
*/
...
// 新的广告页面
import newAdd from './../views/operationManagement/newAdd'
// 分销二维码生成
import DistributionCode from './../views/distribution/DistributionCode'
// 用户增量
import UserIncrement from './../views/distribution/UserIncrement'
// 订单转换量
import OrderConversion from './../views/distribution/OrderConversion'
// 基础表
let Component = {
  home: home,
  user: User,
...
let routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 1208, path: '/newAdd', name: '广告位设置', components: Component }
    ]
  },
  {
    id: 1300,
    ...
    component: Main,
    name: '分销模块',
    iconCls: 'fa fa-phone', // 图标样式class
    children: [
      { id: 1301, path: '/distributionCode', name: '分销二维码生成', components: Component },
      { id: 1302, path: '/userIncrement', name: '用户增量', components: Component },
      { id: 1303, path: '/orderConversion', name: '订单转换量', components: Component }
    ]
  },
  {
    id: 1400,
