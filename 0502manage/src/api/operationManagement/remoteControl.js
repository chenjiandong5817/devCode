...
* @Last Modified time: 2018-06-25 09:43:32
*/
...
export const maintainDevice = () => {
    ...
    return {
        ...
        requetType: 'POST',
        remark: '维修设备',
        go: params => { return axios.post(url + '?deviceid=' + params).then(res => res.data) }
    }
}
...
export const devicesRun = () => {
    ...
    return {
        ...
        requetType: 'GET',
        remark: '设备正常运行台数',
        go: params => { return axios.get(url + '?area=' + params).then(res => res.data) }
    }
}
...
export const queryAllOrder = () => {
    ...
    return {
        ...
        requetType: 'GET',
        remark: '获得订单统计',
        go: params => { return axios.get(url + '?area=' + params.area + '&dateType=' + params.dataType).then(res => res.data) }
    }
}
...
export const removeDevice = () => {
    ...
    return {
        ...
        requetType: 'DELETE',
        remark: '删除设备管理信息',
        go: id => { return axios.delete(url + '?deviceid=' + id).then(res => res.data) }
    }
}

export const getAreaDevices = () => {
    let url = `${bus}/devices/area`
    return {
        name: 'getAreaDevices',
        type: defaultType,
        url: url,
...
export const getDeviceInfo = () => {
    ...
    return {
        ...
        requetType: 'GET',
        remark: '获取单个设备信息',
        go: params => { return axios.get(url + '?deviceid=' + params).then(res => res.data) }
    }
}
