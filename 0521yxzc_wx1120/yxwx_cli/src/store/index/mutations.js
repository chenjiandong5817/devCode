/*
* @Author: cdroid
* @Date:   2018-05-21 11:21:04
* @Last Modified by:   chenjiandong
* @Last Modified time: 2018-07-10 12:11:49
*/
// mutations
...
const SWITCH_PAYTYPE = 'SWITCH_PAYTYPE'
...
const SET_OPENCITYDATA = 'SET_OPENCITYDATA'
...
export default{
  ...
  // 是否手动切换了支付方式
  [SWITCH_PAYTYPE] (state, val) {
    state.hasSwitchPayType = val
  },
  // 设置支付类型
  ...
  // 订单改变
  [CHANGE_ORDER] (state, val) {
    state.orderType = val
  },
  // 设置openCityData
  [SET_OPENCITYDATA] (state, val) {
    state.openCityData = val
  }
}
