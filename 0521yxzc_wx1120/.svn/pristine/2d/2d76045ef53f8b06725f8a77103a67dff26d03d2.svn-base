        ...
        setGearTooth: function (data) {
            ...
            if (l > 0) {
                ...
                if (childData != undefined) {
                    ...
                    if (minute < 45 && (minute + 15) <= 55) {
                        number = Math.ceil((minute + 15) / 10);
                    } else {
                        hour = hour + 1;
                        number = Math.ceil((minute + 15 - 60) / 10);
                    }
                    if (gearVal == 1 && id == 1) {
                        if (childLen == 24) {
                            childData.splice(0, hour - 1);
                        }
                    } else if (gearVal == 0 && id == hour) {// 过滤后的小时，第一个gearVal为0
                        if (childLen == 6) {
                            childData.splice(0, number);
                        }
                    }
                }
                /**
