  ...
  <el-dialog
    ...
    <el-form :model.sync="form" label-position="right" ref="foodTypeForm" :rules="rules">
      ...
      <el-form-item>
        <el-row>
          <el-col :span="24">
            <el-form-item label="计入合计" prop="needCount" :label-width="formLabelWidth" >
              <el-radio-group v-model="form.needCount">
                <el-radio :label="0"  size="small">否</el-radio>
                <el-radio :label="1"  size="small">是</el-radio>
              </el-radio-group>
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    addItem () {
      const newChild = { foodName: this.form.foodName, mainTypeId: this.parent.id, needConflictDetect: this.form.needConflictDetect, needCount: this.form.needCount }
