 ...
 * @Last Modified time: 2018-01-12 15:30:42
 */
<template>
    ...
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
      <el-form :inline="true" :model="filters">
        ...
        <el-form-item style="width: 160px;margin-right:5px;">
          <label style="width: 30%">航季</label>
          <el-select v-model="filters.seasonId" placeholder="航 季" @change="getSeasonSchedulels" style="width: 80%" :filterable="true" clearable>
            <el-option
        ...
        <el-form-item style="width: 215px;margin-right:5px;">
           <label style="width: 35%">计划类型</label>
          <el-select v-model="filters.planSource" placeholder="计划类型" style="width: 70%" @change="getSeasonSchedulels" :filterable="true" clearable>
            <el-option
        ...
        <el-form-item style="width: 160px;margin-right:5px;">
          ...
          <el-input v-model="filters.carrier" placeholder="承运人" :icon="carrierClss" style="width: 70%;" @mouseenter.native="carInputHovering = true"
        ...
        <el-form-item style="width: 160px;">
          ...
          <el-input v-model="filters.flightNo" placeholder="航班号" style="width: 70%;" :icon="iconClass" @mouseenter.native="inputHovering = true"
...
import API from '../../../api'
import addOrUpdate from './planSeascheduleForm/AddOrUpdate'
import commonDelete from './../../../components/CommDelete'
import CityName from '../../../components/CityName'
import impExcel from '../../../common/js/importExcel'
import impExcelPlanSea from './planSeascheduleForm/impExcelPlanSea'
import genMorrowFlight from './planSeascheduleForm/generateFlight'
...
export default {
  ...
  methods: {
    ...
    handleEdit: function (index, row) {
      this.$refs['seascheduleEditForm'].show(row, row.airportCode)
    },
