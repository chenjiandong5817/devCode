  ...
  export default {
    ...
    methods: {
      ...
      getStandCategoriesList: function () {
        ...
        for (var i = 0; i < this.$cache.array.aircraftcategory.length; i++) {
          var item = {}
          item['text'] = this.$cache.array.aircraftcategory[i].categoryCode
          item['value'] = this.$cache.array.aircraftcategory[i].categoryCode
