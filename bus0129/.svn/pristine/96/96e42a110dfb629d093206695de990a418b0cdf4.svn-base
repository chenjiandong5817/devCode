 ...
 * @Last Modified time: 2018-01-09 15:12:31
 * @Description:  基础信息表API
 */
...
export const getFlightnature = () => {
    let url = `${base}/flightnatures`
    return {
        name: 'getFlightnature',
        type: 'flightnature',
        url: url,
        requetType: 'GET',
        remark: '查询航班区域属性代码信息',
