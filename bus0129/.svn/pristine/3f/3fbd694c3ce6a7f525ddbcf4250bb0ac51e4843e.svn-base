...
<div class="ckAndBoardTimeCls">
    <el-form :model="form.checkIn" ref="checkTimeForm">
      ...
      <el-row :gutter="20">
        <el-col :span="6">
          <el-form-item label="计划开始时间" prop="scheduleCheckinOpen" :rules="[ { validator: Rules.validSegTimeType, message: '非法时间格式', trigger: 'blur' } ]">
        ...
        <el-col :span="6">
          <el-form-item label="计划关闭时间" prop="scheduleCheckinClose" :rules="[ { validator: Rules.validSegTimeType, message: '非法时间格式', trigger: 'blur' } ]">
        ...
        <el-col :span="6">
          <el-form-item label="预计开始时间" prop="estimateCheckinOpen" :rules="[ { validator: Rules.validSegTimeType, message: '非法时间格式', trigger: 'blur' } ]">
        ...
        <el-col :span="6">
          <el-form-item label="预计关闭时间" prop="estimateCheckinClose" :rules="[ { validator: Rules.validSegTimeType, message: '非法时间格式', trigger: 'blur' } ]">
    ...
    <el-form :model="form.boardTime" ref="boardTimeForm" style="padding-top: 15px;">
      ...
      <el-row :gutter="20">
        <el-col :span="6">
          <el-form-item label="计划开始时间" prop="scheduleBoardingOpen" :rules="[ { validator: Rules.validSegTimeType, message: '非法时间格式', trigger: 'blur' } ]">
            <date-time v-model="form.boardTime.scheduleBoardingOpen" :visitTime="true" dateStyle="width:68%" datePlaceholder="计划开始日期" timePlaceholder="时间" formatter="yyyy-MM-dd" :allDisable="false"></date-time>
          </el-form-item>
        </el-col>

        <el-col :span="6">
          <el-form-item label="计划关闭时间" prop="scheduleBoardingClose" :rules="[ { validator: Rules.validSegTimeType, message: '非法时间格式', trigger: 'blur' } ]">
            <date-time v-model="form.boardTime.scheduleBoardingClose" :visitTime="true" dateStyle="width:68%" datePlaceholder="计划关闭日期" timePlaceholder="时间" formatter="yyyy-MM-dd" :allDisable="false"></date-time>
          </el-form-item>
        </el-col>

        <el-col :span="6">
          <el-form-item label="预计开始时间" prop="estimateBoardingOpen" :rules="[ { validator: Rules.validSegTimeType, message: '非法时间格式', trigger: 'blur' } ]">
            <date-time v-model="form.boardTime.estimateBoardingOpen" :visitTime="true" dateStyle="width:68%" datePlaceholder="预计开始日期" timePlaceholder="时间" formatter="yyyy-MM-dd" :allDisable="false"></date-time>
          </el-form-item>
        </el-col>

        <el-col :span="6">
          <el-form-item label="预计关闭时间" prop="estimateBoardingClose" :rules="[ { validator: Rules.validSegTimeType, message: '非法时间格式', trigger: 'blur' } ]">
            <date-time v-model="form.boardTime.estimateBoardingClose" :visitTime="true" dateStyle="width:68%" datePlaceholder="预计关闭日期" timePlaceholder="时间" formatter="yyyy-MM-dd" :allDisable="false"></date-time>
          </el-form-item>
        </el-col>
      </el-row>
