 ...
 * @Last Modified time: 2018-01-09 12:10:25
 */
              ...
              <el-col :span="18">
                ...
                <el-form-item label="航空公司">
                  <el-select v-model="FlightLogoData.airCompany" placeholder="选择航空公司" :filterable="true" class="maxWidth">
                    <el-option v-for="item in flightLogoAirline" :key="item.text" :label="item.text" :value="item.value">
                    </el-option>
                  </el-select>
                </el-form-item>
                <el-form-item label="图片尺寸">
                  <el-select v-model="FlightLogoData.imageSize" placeholder="选择图片尺寸" :filterable="true" class="maxWidth">
                    <el-option v-for="item in imageSizeList" :key="item.text" :label="item.text" :value="item.value">
                    </el-option>
                  </el-select>
                </el-form-item>
            ...
            <el-tab-pane label="专柜图片">
              <el-form-item label="当前选中机场">
                  <el-select v-model="FlightLogoData.airportCode" placeholder="请选择机场" class="maxWidth" :disabled="true">
                    <el-option v-for="sub in subscribeAirportsLables" :key="sub.text" :label="sub.text" :value="sub.value">
                    </el-option>
                  </el-select>
              </el-form-item>
              <el-form-item label="航空公司">
                  ...
                  <el-col :span="18">
                    <el-form-item label="服务模式">
                      <el-select v-model="item.serviceMode" placeholder="选择服务模式" :filterable="true" class="maxWidth" @change="getServiceType(index)">
                        <el-option v-for="mode in flightServiceMode" :key="mode.text" :label="mode.text" :value="mode.value">
                        </el-option>
                      </el-select>
                    </el-form-item>
                    <el-form-item label="服务类型">
                      <el-select v-model="item.serviceType" placeholder="选择服务类型" :filterable="true" class="maxWidth">
                        <el-option v-for="Servicetype in flightServiceType" :key="Servicetype.text" :label="Servicetype.text" :value="Servicetype.value">
                        </el-option>
                      </el-select>
                    </el-form-item>
                    <el-form-item label="图片尺寸">
                      <el-select v-model="item.imageSize" placeholder="选择图片尺寸" :filterable="true" class="maxWidth">
                        <el-option v-for="size in imageSizeList" :key="size.text" :label="size.text" :value="size.value">
                        </el-option>
                      </el-select>
                    </el-form-item>
                    <el-form-item label="描述">
