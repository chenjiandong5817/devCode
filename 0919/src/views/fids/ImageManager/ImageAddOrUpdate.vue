 ...
 * @Last Modified time: 2018-01-10 11:26:41
 */
...
import NoCheckIn from '../ImageManager/NoCheckIn'
import StaticName from '../ImageManager/StaticName'
import FlightLogo from '../ImageManager/FlightLogo'
import Destination from '../ImageManager/Destination'
import commonDelete from './../../../components/CommDelete'
import API from './../../../api'
import DestinationEdit from '../ImageManager/DestinationEdit'
import NoCheckInEdit from '../ImageManager/NocheckInEdit'
import FlightLogoEdit from '../ImageManager/FlightLogoEdit'
import CountersEdit from '../ImageManager/CountersEdit'
export default {
  props: {
    title: {
      type: String,
