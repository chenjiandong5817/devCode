 ...
 * @Last Modified time: 2018-01-09 12:06:01
 */
// 航空公司、全开柜台、普通柜台通用模板
<template>
      ...
      <el-card class="box-card maxWidth">
        ...
        <el-form-item label="航空公司">
          <el-select v-model="flightLogoData.airCompany" placeholder="选择航空公司" :filterable="true" class="maxWidth">
            <el-option v-for="item in FlightAirline" :key="item.text" :label="item.text" :value="item.value">
            </el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="图片尺寸">
          <el-select v-model="flightLogoData.imageSize" placeholder="选择图片尺寸" :filterable="true" class="maxWidth">
            <el-option v-for="item in imageSize" :key="item.text" :label="item.text" :value="item.value">
            </el-option>
          </el-select>
        </el-form-item>
