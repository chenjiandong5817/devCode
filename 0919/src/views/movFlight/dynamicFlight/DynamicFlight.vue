 ...
 * @Last Modified time: 2018-01-10 20:30:38
 * @Description: 航班动态
 */
<template>
...
import API from '../../../api'
import addOrUpdate from './dynamicFlightForm/AddOrUpdate'
import commonDelete from './../../../components/CommDelete'
import FlightConfirm from './dynamicFlightForm/FlightConfirm'
import resConfig from './dynamicFlightForm/resConfig'
import vipConfig from './Vip'
import CityName from '../../../components/CityName'
import flightLoadForm from './../flightLoad/flightLoadForm/FlightLoadAddMain'
