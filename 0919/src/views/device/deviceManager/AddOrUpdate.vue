 ...
 * @Last Modified time: 2018-01-15 11:21:36
 */
...
<template>
  <el-dialog :title="title" v-model="visible" :close-on-click-modal="true" :before-close="handleClose" size="small" :modal-append-to-body="false">
    ...
    <el-form :model="deviceInfo" ref="deviceAddOrUpdateForm" :rules="rule1">
      <el-row :gutter="20">
        <el-col :span="6">
          <el-form-item label="机场代码" prop="airportCodeVaild">
      ...
      <el-row :gutter="20">
        <el-col :span="6">
         ...
         <el-col :span="6" >
          <el-form-item label="设备编号" prop="deviceNoValid">
            <el-input v-model="deviceInfo.deviceNo" placeholder="设备编号"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="设备名称" prop="deviceNameValid">
    ...
    <div slot="footer" class="dialog-footer">
      <el-button @click.native="afterCancel">取消</el-button>
...
import Util from '../../../common/js/util'
 ...
 import AddGroup from '../deviceManager/AddGroup'
 ...
 export default {
   ...
   data () {
     var airportValid = (rule, value, callback) => {
       console.log(this.deviceInfo.airportCode)
       if (this.deviceInfo.airportCode === null) {
         callback(new Error('请填写机场代码!'))
       }
       callback()
     }
     var devicenoValid = (rule, value, callback) => {
       console.log(this.deviceInfo.deviceNo)
       if (this.deviceInfo.deviceNo === '') {
         callback(new Error('请填写设备编号!'))
       }
       callback()
     }
     var deviceNameValid = (rule, value, callback) => {
       console.log(this.deviceInfo.deviceName)
     ...
     return {
       ...
       ipAdress: [{
        ...
        rule1: {
          airportCodeVaild: [{ validator: airportValid, trigger: 'blur' }],
          deviceNoValid: [{ validator: devicenoValid, trigger: 'blur' }],
          deviceNameValid: [{ validator: deviceNameValid, trigger: 'blur' }]
        }
      }
   },
   ...
   methods: {
    ...
    getDeviceGroup () {
      this.loading = true
      let para = Object.assign({}, {pageSize: 100000})
