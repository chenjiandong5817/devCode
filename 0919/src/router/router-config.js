...
* @Last Modified time: 2018-04-02 09:19:33
*/

// import Home from '../views/movFlight/dynamicFlight/DynamicFlight'
...
import DeviceManage from '../views/device/deviceManager/DeviceManage'
import DynamicFlight from '../views/movFlight/dynamicFlight/DynamicFlight'
import VncManage from '../views/device/vncManager/VncManage'
// import CommTable from './../components/CommTable'
import VersionManagement from './../views/system/VersionManagement'
// 多语言管理
import MultiLanguage from '../views/fids/mutiLang/MultiLanguage'
// 基础表
...
import ImageManage from '../views/fids/ImageManager/ImageManage'
import Generalagents from './../views/base/Generalagents'
import Display from './../views/fids/DisplayManager/Display'
...
import PlanFlightSchedule from '../views/movFlight/planFlightSchedule/PlanFlightSchedule'
import Vip from './../views/movFlight/vipManage/Vip'
import PlanSeasonSchedule from '../views/movFlight/PlanSeaSchedule/PlanSeasonSchedule'
import DestLang from './../views/base/DestLang'
import SeasonName from './../views/movFlight/SeasonName'
import VisualTools from './../views/device/VisualTools'
import DataSource from './../views/fids/DataSourceManager/DataSource'
import FlightLoad from './../views/movFlight/flightLoad/FlightLoad'
import MorFlightGenerateTime from './../views/movFlight/MorFlightGenerateTime'
// import DeviceFault from '../views/device/DeviceFault'
// import DeviceRepair from '../views/device/DeviceRepair'
import PreviewTable from './../views/movFlight/previewTable'
import TemplateEditor from './../views/fids/templateEditor/TemplateEditor'
import DeviceDistribution from '../views/device/deviceDistribution/DeviceDistribution'
import DeviceIrregular from '../views/device/deviceIrregular/DeviceIrregular'
import DeviceRepairRecord from '../views/device/deviceRepairRecord/DeviceRepairRecord'
// import FlightBoard from '../views/smartbi/FlightBoard'
...
let Component = {
  ...
  deviceIrregular: DeviceIrregular,
  deviceRepairRecord: DeviceRepairRecord
...
let routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 1305, path: '/versionmanagement', name: '版本管理', components: Component }
    ]
  },
  {
    id: 1400,
    ...
    children: [
      ...
      { id: 1403, path: '/deviceDistribution', name: '设备分布图', components: Component },
      { id: 1404, path: '/deviceIrregular', name: '设备异常管理', components: Component },
      { id: 1405, path: '/deviceRepairRecord', name: '设备异常维修管理', components: Component }
    ]
  },
  {
    id: 1500,
    ...
    children: [
      ...
      { id: 1503, path: '/dynamicFlight', name: '航班动态管理', components: Component },
  ...
  },
  {
    ...
    children: [
      ...
      { id: 1604, path: '/templateEditor', name: '模板编辑器', components: Component },
  ...
  //   iconCls: 'fa fa-plane',
  //   children: [
  //     { id: 1701, path: '/flightBoard', name: '航班业务面板', components: Component }
  //   ]
  // },
  {
    id: 9999,
