 ...
 * @Last Modified time: 2018-01-10 10:02:00
 */
<template>
  <section>
    <!--搜索工具栏（整行、置顶）-->
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
      <el-form :inline="true" :model="filters">
        ...
        <el-form-item>
          <el-select v-model="filters.displayType" placeholder="业务类型" @change="autoShow" filterable clearable>
              <el-option
                v-for="(item, index) in deviceTypeLabels"
                :key="index"
                :label="item.text"
                :value="item.value">
              </el-option>
...
import settingScrollText from '../deviceManager/SettingScrollText'
import batchDeal from '../deviceManager/BatchDeal'
