  ...
  <section>
    ...
    <el-table v-bind:data="vips" highlight-current-row v-loading="listLoading" @selection-change="selsChange" :height="tableHeight" style="width: 100%;">
      ...
      <el-table-column label="VIP名字" min-width="100" style="border-left: 1px solid #e8ecf2;">
        <template slot-scope="scope">
          <div class="content-rowspan">
            <div class="table_cell_height" v-for="item1 in scope.row.vipDetails">{{ item1.vipName }}</div>
          </div>
        </template>
      </el-table-column>
      <el-table-column label="职务" min-width="100">
        <template slot-scope="scope">
          <div class="content-rowspan">
            <div class="table_cell_height" v-for="item2 in scope.row.vipDetails">{{ item2.title }}</div>
          </div>
        </template>
      </el-table-column>
      <el-table-column label="舱位" min-width="100">
        <template slot-scope="scope">
          <div class="content-rowspan">
            <div class="table_cell_height" v-for="item3 in scope.row.vipDetails">{{ item3.cabin }}</div>
          </div>
        </template>
      </el-table-column>
      <el-table-column label="座位" min-width="100">
        <template slot-scope="scope">
          <div class="content-rowspan">
            <div class="table_cell_height" v-for="item4 in scope.row.vipDetails">{{ item4.seat }}</div>
          </div>
        </template>
      </el-table-column>
...
<script>
  ...
  import commonAddOrUpdate from './../vipManage/AddOrUpdate'
    ...
    methods: {
      ...
      handleAdd: function () {
        ...
        let addFields = {
          ...
          remark: '',
          airportCode: this.filters.airportCode,
          vipDetails: [
               {
                no: 0,
                vipName: '',
