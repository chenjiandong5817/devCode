 ...
 * @Last Modified time: 2018-01-09 14:17:07
 * 播放列表多选添加界面
 */
<template>
...
export default {
  ...
  methods: {
    ...
    getInfoList (airportCode) {
      ...
      // this.device = this.$cache.fetch('deviceInfo') || []   // 不从缓存获取了,从api获取
    },
    show (airport) {
