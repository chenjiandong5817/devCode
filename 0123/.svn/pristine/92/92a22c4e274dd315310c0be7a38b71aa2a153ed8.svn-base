...
export default {
        ...
        h(
          ...
          [
            this._l(this.columns, column => {
              return h(
                'col',
                { attrs: { name: column.id, width: column.realWidth || column.width } }
              )
            })
          ]
        ),
              ...
              return [ h(
                'tr',
                {
                  ...
                  on: {
                    ...
                    mouseleave: _ => this.handleMouseLeave()
                  },
                ...
                [
                  ...
                  !this.fixed && this.layout.scrollY && this.layout.gutterWidth ? h('td', { class: 'gutter' }) : ''
                ]
                ),
  ...
  methods: {
    ...
    handleMouseEnter (index) {
      this.store.commit('setHoverRow', this.table.hoverRow ? index : null)
    },
